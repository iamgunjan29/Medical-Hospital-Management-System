...
class Application :
    ...
    #creating frames in the master
        ...
        self.heading=Label(self.left,text='XYZ HOSPITAL APPOINTMENTS',font=('arial 25 bold'),fg='black',bg='lightgreen')
        ...
        self.age = Label(self.left, text="Patient's Age", font=('arial 18 bold'), fg='black', bg='lightgreen')
        self.age.place(x=0, y=140)

        #gender

        self.gender= Label(self.left, text="Patient's gender", font=('arial 18 bold'), fg='black', bg='lightgreen')
        self.gender.place(x=0, y=180)

        #location
        self.location = Label(self.left, text="Patient's Location", font=('arial 18 bold'), fg='black', bg='lightgreen')
        ...
        self.date = Label(self.left, text="Appointment Date", font=('arial 18 bold'), fg='black', bg='lightgreen')
        self.date.place(x=0,y=340)

        #problem

        self.pro = Label(self.left, text="Problem", font=('arial 18 bold'), fg='black', bg='lightgreen')
        self.pro.place(x=0, y=380)

        #department

        self.dep = Label(self.left, text="Department", font=('arial 18 bold'), fg='black', bg='lightgreen')
